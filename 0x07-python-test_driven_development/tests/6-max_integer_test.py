...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_unordered_larger(self):
        """Unittest for max_integer([..])"""
        self.assertEqual(max_integer([123, 538, 91, 24, 11024, 89, 98,
                                     1080, 25, 12]), 11024)

    def test_positives_and_negatives(self):
        """Unittest for max_integer([..])"""
        self.assertEqual(
            max_integer([-213, 58, 91, 124, -1024, 89, 8, 180, -256, -512]),
            180)
        ...
        self.assertEqual(
            max_integer(
                [-6105619, -854849, -562553, -3088955, -6711290, -4817844,
                    ...
                    -967891, -4663691, -7156, -7153670, -8038202,
                    ...
                    -2839083, -2586661, -9941097, -3136620]), -7156)
        ...
        self.assertEqual(
            max_integer(
                [199872.7619047619, 115249.8813559322, 37972.944444444445,
                    ...
                    393382.5416666667, 15441.826086956522, 3503567,
                    ...
                    142333.11764705883, 199123.75]), 3503567)
